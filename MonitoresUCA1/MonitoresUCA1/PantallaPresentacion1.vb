Public NotInheritable Class PantallaPresentacion1
    ...
    Private Sub PantallaPresentacion1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
